...
public class Slide : StateMachineBehaviour
{
    ...
    private RunmanController controller;
    ...
    {
        controller = animator.GetComponent<RunmanController>();
        controller.currentState = State.Slide;
        finished = false;
    }
    ...
    {
        controller.currentState = State.Running;
    }
